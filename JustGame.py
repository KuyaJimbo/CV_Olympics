...
class Player:
    def __init__(self):
        ...
        # the block box is the area where the player can block the ball
        # template for pygame.Rect(left, top, width, height)
        self.BLOCKTYPE = "None"
        # block box for the player
...
while True:
    ...
    if player.image != player_images["B_Idle"]:
        player.draw_blockbox(screen)
